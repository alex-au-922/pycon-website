...
export default function BannerImageSlide() {
  ...
  return (
    <div className="relative w-full md:max-w-144 xl:max-w-192 h-64 sm:h-74 md:h-80 xl:h-106 flex items-center justify-center opacity-75 border-4 rounded-3xl border-gray-700 ml-8 xl:ml-0 group">
