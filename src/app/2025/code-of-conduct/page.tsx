  ...
  return (
    <>
      ...
      <div className="space-y-6 text-gray-00 mt-4">
        ...
        <p>
          We value the participation of each member of the Python community and want all attendees to have an enjoyable
          and fulfilling experience. Accordingly, all attendees are expected to show respect and courtesy to other
          attendees throughout the conference and at all conference events, whether officially sponsored by the PyCon
          Hong Kong organisers or not.
        </p>
        <p>
          To make clear what is expected, all staff, attendees, speakers, exhibitors, organizers, and volunteers at any
          PyCon event are required to conform to the following Code of Conduct. Organizers will enforce this code
          throughout the event.
        </p>
        <h2 className="text-2xl font-bold text-sky-600 mt-8 mb-4">Our Standards</h2>
        <p>
        ...
        <ul className="mt-4 list-disc ml-6 space-y-2">
          ...
          <li className="md:pl-2">Being respectful of differing viewpoints and experiences</li>
          <li className="md:pl-2">Gracefully accepting constructive criticism</li>
          <li className="md:pl-2">Focusing on what is best for the community</li>
          <li className="md:pl-2">Showing empathy towards other community members</li>
        </ul>
        <p>Examples of unacceptable behavior by participants include:</p>
        <ul className="mt-4 list-disc ml-6 space-y-2">
          <li className="md:pl-2">Harassment of conference participants in any form</li>
          <li className="md:pl-2">Deliberate intimidation, stalking, or following</li>
          <li className="md:pl-2">Violent threats or language directed against another person</li>
          <li className="md:pl-2">Sexual language and imagery in any conference venue, including talks</li>
          <li className="md:pl-2">Insults or put downs</li>
          <li className="md:pl-2">Sexist, racist, homophobic, transphobic, ableist, or exclusionary jokes</li>
          ...
          <li className="md:pl-2">Sustained disruption of talks or other events</li>
        ...
        <h2 className="text-2xl font-bold text-sky-600 mt-8 mb-4">Weapons Policy</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-sky-600 mt-8 mb-4">Contact Information</h2>
        <p>
          If you believe that someone is violating the code of conduct during a PyCon event, or have any other concerns,
        ...
        <p>
          ...
          provide escorts, or otherwise assist any attendee to feel safe for the duration of the conference. We value
          your attendance.
        </p>
        <h2 className="text-2xl font-bold text-sky-600 mt-8 mb-4">Procedure for Handling Incidents</h2>
        <p>
          <Link
