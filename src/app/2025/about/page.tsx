        ...
        <div className="bg-white bg-opacity-90 rounded-xl shadow-xl p-8 md:p-12 relative mt-20">
          ...
          <div className="space-y-6 text-gray-700 text-base/7 md:text-lg text-justify">
            <p>
              ...
              insights and foster collaboration. Among the 50+ PyCons hosted
              annually in various cities and countries worldwide, PyCon HK is
            ...
            <p className="mt-4">
              ...
              , who drew inspiration from the PyCon APAC 2013 event in Tokyo.
              Sammy recognized that Hong Kong was missing out on this vital
              Python conference, despite PyCon being hosted in various Asian
              cities. Determined to fill this gap, Sammy collaborated with
              &nbsp;
              <Link
              ...
              &nbsp; to organize the inaugural PyCon HK in 2015. Since then,
              PyCon HK has played a pivotal role in nurturing Python development
              and adoption within the city.
            </p>

            <p className="mt-4">
              In 2025, PyCon Hong Kong celebrates its 11th anniversary with Mr.
              Henry Law as the Chairman of PyCon HK 2025. A cornerstone of the
